...
public class GamestatePreflopPacket extends Packet {
    ...
    public int dealer, bigBlindID, smallBlindID, firstTurn, bigBlindAmount, smallBlindAmount, currentBet, maximumBet;
    ...
    public GamestatePreflopPacket(int dealer, int bigBlindID, int smallBlindID, int firstTurn, Card leftCard, Card rightCard, int[] playing,
                                  int bigBlindAmount, int smallBlindAmount, int currentBet, int maximumBet) {
        this.dealer = dealer;
